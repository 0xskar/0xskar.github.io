...
## [](#header-2)Enter the key you found!

- Using ``strings`` we can find the name and the key.

* * * 

## [](#header-2)What is Charlie's password?

- we found this already with stegseek

* * * 

## [](#header-2)change user to charlie

- login to ssh with the non password protected rsa key

* * * 

## [](#header-2)Enter the user flag

- ``cat user.txt``

* * * 

## [](#header-2)Enter the root flag
