...
## [](#header-2)Scan the machine, how many ports are open?

- ``sudo nmap -T4 -F 10.10.173.237``

* * *

## [](#header-2)What service is running on port 22?

- ``sudo nmap -sV -sT -p22,80 10.10.173.237``

* * *

## [](#header-2)What service is running on port 80?

- ``sudo nmap -sV -sT -p22,80 10.10.173.237``

* * *

## [](#header-2)What is the user.txt flag?
...
## [](#header-2)What is the root.txt flag?
