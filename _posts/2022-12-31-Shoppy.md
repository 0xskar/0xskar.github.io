...
Description: Bypass a login screen with NoSQL injection, enumerate credentials on subdomains, reverse engineer a password protecter and privesc and escape docker container.
