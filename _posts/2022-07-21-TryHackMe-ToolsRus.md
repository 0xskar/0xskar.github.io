...
## [](#header-2)What directory can you find, that begins with a "g"?
...
## [](#header-2)Whose name can you find from this directory?

- Visit ``/guidelines/`` - bob

* * * 

## [](#header-2)What directory has basic authentication?

- ``/protected/``

* * * 

## [](#header-2)What is bob's password to the protected part of the website?
...
## [](#header-2)What other port that serves a webs service is open on the machine?

- ``sudo nmap -Pn -sS -p- -T4 10.10.192.13 -vvv``

* * * 

## [](#header-2)Going to the service running on that port, what is the name and version of the software?
...
## [](#header-2)Use Nikto with the credentials you have found and scan the /manager/html directory on the port found above.
...
## [](#header-2)What is the server version (run the scan against port 80)?

- ``nmap -sV -sT -p22,80,8009 -T4 10.10.192.13 -vvv``

* * * 

## [](#header-2)What version of Apache-Coyote is this service using?

- ``nmap -sV -sT -p22,80,8009 -T4 10.10.192.13 -vvv``

* * * 

## [](#header-2)Use Metasploit to exploit the service and get a shell on the system.
